...
import 'package:paklan/novedades/BurritoDetails.dart';
...
class BurritosListPage extends StatefulWidget {
  @override
  _BurritosListPageState createState() => _BurritosListPageState();
}

class _BurritosListPageState extends State<BurritosListPage>  {
          ...
          Positioned(
            ...
            child: DecoratedBox(
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(color: Colors.teal, blurRadius: 90, spreadRadius: 45)
                ]
              ),
            )
          ),
                  ...
                  onTap: (){
                    Navigator.of(context).push(
                      PageRouteBuilder(
                        ...
                        pageBuilder: (_, animation, __) => FadeTransition(opacity: animation, child: BurritosDetailPage(burritoModels: burrito))
                      )
                    );
                  },
                  child: Padding(
                    ...
                    child: Transform(
                      ...
                      child: Opacity(
                        ...
                        child: Hero(
                          tag: burrito.name,
                          child: Image.asset(burrito.image, fit: BoxFit.fitHeight,)
                        )
                      )
                    ),
                  ),
              ...
              child: Column(
                children: [
                  ...
                  AnimatedSwitcher(
                    ...
                    duration: duration,
                    child: Text('\$${ burritos[_currentPage.toInt()].price.toStringAsFixed(2) }',
