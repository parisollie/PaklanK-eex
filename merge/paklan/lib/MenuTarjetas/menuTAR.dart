...
import 'package:paklan/MenuTarjetas/BurritoDetails.dart';
          ...
          Positioned(
            ...
            child: DecoratedBox(
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(color: Color.fromARGB(255, 14, 128, 138), blurRadius: 90, spreadRadius: 45)
                ]
              ),
            )
          ),
                  ...
                  onTap: (){
                    Navigator.of(context).push(
                      PageRouteBuilder(
                        ...
                        pageBuilder: (_, animation, __) => FadeTransition(opacity: animation, child: BurritosDetailPage(burritoModels: tarjeta))
                      )
                    );
                  },
                  child: Padding(
                    ...
                    child: Transform(
                      ...
                      child: Opacity(
                        ...
                        child: Hero(
                          tag: tarjeta.name,
                          child: Image.asset(tarjeta.image, fit: BoxFit.fitHeight,)
                        )
                      )
                    ),
                  ),
              ...
              child: Column(
                children: [
                  ...
                  AnimatedSwitcher(
                    ...
                    duration: duration,
                    child: Text('\$${ tarjetas[_currentPage.toInt()].price.toStringAsFixed(2) }',
